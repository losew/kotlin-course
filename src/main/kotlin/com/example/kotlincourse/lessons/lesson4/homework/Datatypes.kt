package com.example.kotlincourse.lessons.lesson4.homework
...
// тут ошибка, false пишется маленькими буквами:
// val v6 = FALSE
...
// тут ошибка: для Char слишком много символов, а для String нужны двойные кавычки:
// val v20 = `1.414`
...
// тут ошибка, неправильные кавычки
// val v32 = “🤯”
